...
// Utility Functions
// -----------------------------
int generateUserID() { lastUserID++; return lastUserID; }
int generateRestaurantID() { lastRestaurantID++; return lastRestaurantID; }
int generateMenuItemID() { lastMenuItemID++; return lastMenuItemID; }
int generateOrderID() { lastOrderID++; return lastOrderID; }
        ...
        if (choice == 1)
        {
            ...
            for (int i = 0; i < restaurantCount; i++)
            {
                cout << restaurants[i].id << ". "
                     << restaurants[i].name << " (" << restaurants[i].location << ")\n";
            }
